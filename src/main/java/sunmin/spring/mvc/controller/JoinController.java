...
import sunmin.spring.mvc.service.MemberService;
...
public class JoinController {
    ...
    // 서블릿에서 제공하는 HttpServletResponse를 이용하면 스프링의 뷰리졸버 없이 바로 응답을 출력할 수 있음
    ...
    // 즉, 서버가 생성한 정보를 일정기간 동안 WAS(Web Application Server)에 저장해두고
    // 필요할 때마다 이것을 활용함으로써 로그인한 사용자를 식별할 수 있음
