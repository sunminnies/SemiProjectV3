    ...
    <form id="joinfrm" name="joinfrm">
        ...
        <div class="col-11 offset-1">
            ...
            <div class="form-group row">
                ...
                <span id="pwdmsg" class="col-form-label"> &nbsp; 8~16 자의 영문 대소문자, 숫자 및 특수문자 사용할 수 있습니다.</span>
            </div> <!-- 비밀번호 -->
            ...
            <div class="form-group row">
                ...
                <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#zipmodal"><i class="fas fa-question-circle"> 우편번호 찾기</i></button>
            </div> <!-- 우편번호 -->
...
<!-- 우편번호 찾기 폼 모달 -->
<div class="modal" id="zipmodal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" id="sendzip">
                    <i class="fas fa-check-square"> 선택하고 닫기</i></button>
            </div>
        </div>
    </div>
</div>
