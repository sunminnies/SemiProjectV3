...
<div class="card card-body bg-light">
 ...
 <form id="checkfrm2" name="checkfrm2">
     ...
     <div class="row">
         <div class="col text-center">
             <hr>
             <button type="button" id="chk2btn" class="btn btn-primary"><i class="fas fa-check"> 확인하기</i></button>
             <button type="button" id="cancel2btn" class="btn btn-danger"><i class="fas fa-times"> 취소하기</i></button>
         </div>
     </div> <!-- 버튼 -->
 </form>
</div> <!-- 실명확인 -->
